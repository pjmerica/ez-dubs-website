...
Writes source=manual rows for 2026-07-03 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "Underdog Rankings 0703.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(37).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(6).csv"
