...
Writes source=manual rows for 2026-07-12 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "rankings-a9c04e81-1ace-4b16-a31d-4c725a47f16f-ccf300b0-9197-5951-bd96-cba84ad71e86(15).csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(45).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(13).csv"
