...
Writes source=manual rows for 2026-07-04 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "underdog rankings 0704.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(38).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(7).csv"
