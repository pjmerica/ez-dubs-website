...
Writes source=manual rows for 2026-07-18 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "0718 rankings-a9c04e81-1ace-4b16-a31d-4c725a47f16f-ccf300b0-9197-5951-bd96-cba84ad71e86(20).csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "0718 DkPreDraftRankings(50).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "0718 drafters_players(18).csv"
