...
Writes source=manual rows for 2026-07-09 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "UnderDog Rankings 079.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(43).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(11).csv"
