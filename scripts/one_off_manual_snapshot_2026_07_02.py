...
Writes source=manual rows for 2026-07-02 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "Underdog Rankings (2).csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(35).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(5).csv"
