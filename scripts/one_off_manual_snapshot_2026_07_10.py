...
Writes source=manual rows for 2026-07-10 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "0710 rankings-a9c04e81-1ace-4b16-a31d-4c725a47f16f-ccf300b0-9197-5951-bd96-cba84ad71e86(14).csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "0710 DkPreDraftRankings(44).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "0710 drafters_players(12).csv"
