...
Writes source=manual rows for 2026-06-29 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "Underdog Rankings 0629.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(32).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(2).csv"
