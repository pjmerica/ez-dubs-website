...
Writes source=manual rows for 2026-07-01 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "Underdog 0701.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(34).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(4).csv"
