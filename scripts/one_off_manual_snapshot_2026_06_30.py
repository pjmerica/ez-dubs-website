...
Writes source=manual rows for 2026-06-30 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "Underdog Rankings 0630.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(33).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(3).csv"
