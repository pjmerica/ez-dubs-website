...
Writes source=manual rows for 2026-07-06 to:
...
UD_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "Underdog Rankings 0706.csv"
DK_DROP        = REPO_ROOT / "_local" / "manual-snapshots" / "DkPreDraftRankings(40).csv"
DRAFTERS_DROP  = REPO_ROOT / "_local" / "manual-snapshots" / "drafters_players(9).csv"
